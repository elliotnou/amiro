// Simple SVG icons — no emoji dependencies

/** Amily logo: three connected nodes representing a friendship graph */
export function LogoIcon({ size = 32 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* Edges */}
      <line x1="10" y1="10" x2="16" y2="22" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/>
      <line x1="22" y1="10" x2="16" y2="22" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/>
...
export function IconCake({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function IconPaintbrush({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M18.37 2.63a2.12 2.12 0 013 3L14 13l-4 1 1-4z"/>
      <path d="M9 14.5A3.5 3.5 0 005.5 18c-1.2 0-2.5.7-2.5 2 2.5 0 4.5-1.3 5-3.5"/>
    </svg>
  )
}
...
export function IconStar({ size = 16, filled = false }: { size?: number; filled?: boolean }) {
  return (
